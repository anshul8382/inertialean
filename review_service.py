...
class ReviewService:
    ...
    def generate_client_review(client_id, start_date, end_date, review_type='comprehensive'):
        ...
        try:
            ...
            if review_type in ['comprehensive', 'performance']:
                review_data['sections']['performance'] = ReviewService._analyze_performance(
                    client, start_dt, end_dt
                )
            
            if review_type in ['comprehensive', 'allocation']:
                review_data['sections']['allocation'] = ReviewService._analyze_allocation(
                    client, start_dt, end_dt
                )
    ...
    def _analyze_performance(client, start_date, end_date):
        ...
        try:
            ...
            # Get benchmark performance (Nifty)
            benchmark_return = ReviewService._get_benchmark_return(start_date, end_date)
